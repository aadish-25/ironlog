...
export function ProfileHeader({
  ...
  return (
    <header className="flex flex-col items-center px-5 pt-[52px] pb-5">
      {/* Avatar */}
      <div className="relative mb-4">
        <div className="w-20 h-20 rounded-full bg-raised border-2 border-border flex items-center justify-center cursor-pointer">
